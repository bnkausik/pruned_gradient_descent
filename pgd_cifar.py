############################################################
#pruned gradient descent for CIFAR10
...
for i in range(n_epochs):
    model.fit(train_images, train_labels, epochs=1,verbose=v_flag)
    err_log[0,i]=model.evaluate(train_images,  train_labels, verbose=v_flag)
